...
$ads = [
    ...
    $pubblicitaVisibile = $pubblicitaActive[rand(0, count($pubblicitaActive) -1)];
...
<body>
    <div>
        <a href="<?php echo $pubblicitaVisibile['link']?>">
            <img src="<?php echo $pubblicitaVisibile['image_path']?>" >
        </a>
    </div>
